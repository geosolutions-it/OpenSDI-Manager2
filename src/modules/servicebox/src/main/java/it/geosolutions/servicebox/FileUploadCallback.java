...
public class FileUploadCallback implements Serializable, Callback {
    ...
    public ServiceBoxActionParameters onPost(HttpServletRequest request,
        ...
        if (itemSize > this.callbackConfiguration.getMaxItems()) {
            ...
            message = "Max items size exceeded (expected: '"
                    + this.callbackConfiguration.getMaxItems() + "', found: '" + itemSize + "').";
            ...
            message = "Max item size exceeded (expected: '"
                    + this.callbackConfiguration.getMaxSize() + "', found: '" + maxSize
                    + "' on item '" + itemName + "').";
            ...
            message = "File type not maches with known file types: (expected: '" + expected
                    + "', item '" + itemName + "').";
        }
        if (error) {
    ...
    /**
     * @param callbackConfiguration the callbackConfiguration to set
     */
    public void setCallbackConfiguration(FileUploadCallbackConfiguration callbackConfiguration) {
