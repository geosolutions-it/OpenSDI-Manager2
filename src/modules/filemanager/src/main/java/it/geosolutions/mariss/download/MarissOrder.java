...
public class MarissOrder extends HashMap<String, HashMap<String, ArrayList<String>>>
        implements Order {
    /**
     * Method that provides the files to create in from this order
     * 
     * @return a map with the path of the file to create and the path of the file
     */
