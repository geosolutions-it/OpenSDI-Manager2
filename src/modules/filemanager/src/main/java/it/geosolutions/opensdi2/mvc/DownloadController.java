...
import it.geosolutions.mariss.download.MarissOrder;
...
/**
 * Controller for the base Download Service. Is more powerful that the simple file browser because it allows to use a custom download service.
 * 
...
public class DownloadController {
    ...
    public @ResponseBody OrderInfo download(@RequestBody ListOrder order,
            HttpServletRequest request) {

        if (downloadService == null) {
            throw new IllegalStateException("The downloadService for the module '"
                    + DownloadController.class + "' cannot be loaded...");
        }
    ...
    /**
     * Create an order for a generic order
     * 
     * @param order
     * @param request
     * @return
    ...
    public @ResponseBody OrderInfo download(@RequestBody MarissOrder order,
            HttpServletRequest request) {
    ...
    public void getOrder(@PathVariable(value = "id") String id, HttpServletRequest request,
        ...
        try {
            ...
            LOGGER.error("error during ZIP file creation in the module " + DownloadController.class,
                    e);
    ...
    public void setDownloadService(@SuppressWarnings("rawtypes") DownloadService downloadService) {
